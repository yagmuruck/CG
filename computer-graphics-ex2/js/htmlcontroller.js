...
HtmlController.prototype.onWindowResize = function()
{
    ...
    this.sceneController.renderer.setSize( window.innerWidth/3, window.innerHeight);
    this.sceneController.clipRenderer.setSize( window.innerWidth/3, window.innerHeight);
    this.sceneController.screenRenderer.setSize( window.innerWidth/3, window.innerHeight);
